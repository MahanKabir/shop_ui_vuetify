<template>
    <div dir="rtl" style="font-family: 'Vazir', sans-serif; text-align:right; color:black" class="white">
        <v-container col-10>
            ...
            <br>
            <div>
                <h3>درباره دیجی‌استایل</h3>
                <br>
                <p style="font-size:1.2vw; color:gray">
            ...
            <div align="center" justify="center" style="text-align:center">
                <v-icon color="grey darken-4" style="margin-right:10px; font-size:2.5vw">fa-instagram</v-icon>
                <v-icon color="grey darken-4" style="margin-right:10px; font-size:2.5vw">fa-telegram</v-icon>
                <v-icon color="grey darken-4" style="margin-right:10px; font-size:2.5vw">fa-facebook-square</v-icon>
                <v-icon color="grey darken-4" style="margin-right:10px; font-size:2.5vw">fa-twitter</v-icon>
            ...
            <div>
                ...
                <v-icon color="grey darken-2" style="margin-right:10px; font-size:1.5vw">fa-check</v-icon>
                <span style="font-size:1.2vw; margin-right:1vw; color:gray">اصالت برند کالا</span>
                <br>

                <v-icon color="grey darken-2" style="margin-right:10px; font-size:1.5vw">fa-check</v-icon>
                <span style="font-size:1.2vw; margin-right:1vw; color:gray">قیمت مناسب</span>
                <br>

                <v-icon color="grey darken-2" style="margin-right:10px; font-size:1.5vw">fa-check</v-icon>
                <span style="font-size:1.2vw; margin-right:1vw; color:gray">تحویل روزانه</span>
                <br>

                <v-icon color="grey darken-2" style="margin-right:10px; font-size:1.5vw">fa-check</v-icon>
                <span style="font-size:1.2vw; margin-right:1vw; color:gray">خدمات پس ار فروش</span>
            </div>
